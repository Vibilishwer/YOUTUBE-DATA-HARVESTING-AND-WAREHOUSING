...
with data:
    if selected=='HOME':
        ...
        st.info("Please note: Using Google API key we can raise maximum 10000 request per day",icon='ℹ️')
        st.markdown(' * Select a particular channel on youtube webpage *:blue[right click on mouse > view page resource]* click on **:blue[ctrl+f]** for find option there you will search for :blue[channelId] there you find like this - ***:blue[UCiEmtpFVJjpkdhmQ2AhxVA]***')
